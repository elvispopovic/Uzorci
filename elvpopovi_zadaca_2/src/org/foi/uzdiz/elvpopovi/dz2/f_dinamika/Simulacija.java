...
public class Simulacija implements SimulacijaSucelje
{
    ...
    public Simulacija(ProblemskiAbstractProduct problemske, Statistika statistika)
    {
        ...
        listaKontrola = new ListaVozila();
        listaKvar = new ListaVozila();
        listaZavrseno = new ListaVozila();
    ...
    @Override
    public ListaVozila DajListaKontrola()
    {
        return listaKontrola;
    }
    @Override
    public ListaVozila DajListaKvar()
    {
        return listaKvar;
    }
    
    @Override
    public ListaVozila dajListaZavrseno()
    {
        return listaZavrseno;
    }
    ...
    public void PostaviListeUlica()
    {
        int i, j;
        int[] redoslijed;
        redoslijed = kreirajRedoslijed1(listaUlica.size());
    ...
    public boolean ObradiVozilaUPrikupljanju()
    {
        ...
        {   
            if((vozilo = listaPrikupljanje.DajVozilo(obrada)) == null)
                return true;
            //if(provjeriKvar(vozilo))
            //    continue;
            if(vozilo.IsprazniSpremnik()==true)
                zavrsiSVozilom(vozilo, obrada);
            else if((vozilo.ProvjeriNapunjenost())==true)
                PosaljiNaDeponij(obrada);
        }
        return false;
    }
    @Override
    ...
    protected void zavrsiSVozilom(VoziloSucelje vozilo, int brojUListi)
    {
        ...
        listaZavrseno.UbaciVozilo(vozilo);
    }
    ...
    protected ListaVozila listaKontrola, listaKvar, listaZavrseno;
