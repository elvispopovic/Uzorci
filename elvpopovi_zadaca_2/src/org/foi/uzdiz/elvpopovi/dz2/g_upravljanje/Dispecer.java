...
import org.foi.uzdiz.elvpopovi.dz2.f_dinamika.Simulacija;
import org.foi.uzdiz.elvpopovi.dz2.f_dinamika.SimulacijaSucelje;
import org.foi.uzdiz.elvpopovi.dz2.f_dinamika.Statistika;
...
public class Dispecer implements SimulacijaSucelje
{
    ...
    {
        return simulacija.DajListaKontrola();
    }
    ...
    {
        return simulacija.DajListaKvar();
    }

    @Override
    public ListaVozila dajListaZavrseno()
    {
        return simulacija.dajListaZavrseno();
    }
