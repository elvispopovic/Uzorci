...
import org.foi.uzdiz.elvpopovi.dz2.c_podaci.PodaciIteratorSucelje;
import org.foi.uzdiz.elvpopovi.dz2.d_komuna.Korisnik;
import org.foi.uzdiz.elvpopovi.dz2.d_komuna.Podrucje;
import org.foi.uzdiz.elvpopovi.dz2.d_komuna.PodrucjeSucelje;
...
{  
    ...
    public void KreirajPodrucja()
    {
        ...
        Podaci podaciPodrucja = podaci.dajPodrucja();
    ...
    private HashMap<String,Podrucje> parsirajPodrucja(Podaci podaciPodrucja, ArrayList<String> dijelovi)
    {
    ...
    void ispisiKorisnike()
    {
        ...
        for(Ulica ulica : listaUlica)
        {
            ...
            for(int vrsta=0; vrsta<3; vrsta++)
            {
                ...
                {
                    Korisnik korisnik = korisniciVrsta.get(i);
                    System.out.println("Korisnik "+korisnik.dajId()+", kategorija "+korisnik.dajKategorija());
                    ArrayList<Spremnik> spremniciKorisnika = korisnik.DajSpremnike();
